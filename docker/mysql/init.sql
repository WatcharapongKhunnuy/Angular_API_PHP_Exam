...
CREATE DATABASE IF NOT EXISTS ruts CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE ruts;

-- Table for Curriculums
...
-- --- ใส่ข้อมูลจริงที่คุณต้องการลงไป ---

INSERT INTO curriculums (id, name_th, name_en, degree_full_th, degree_short_th, degree_full_en, degree_short_en, total_credits, format, type, language, admission, collaboration, graduation)
VALUES (1, 
